...
if(!isset($_SESSION['logged_in'])){
    header('location: ../checkout.php?message=Please login/register to place an order');
            ...
            if(isset($_POST['place_order'])){
                ...
                {
                $product = $_SESSION['cart'][$key]; //Taking each product as a array filled with its own details
                ...
                //6. inform user whether everything is fine or there's a problem
                header('location: ../order_confirm.php?order_status=Order placed successfully!');
